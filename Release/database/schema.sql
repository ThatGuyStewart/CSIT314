...
VALUES
    ...
    ('Amelia Reed', 'amelia@example.com', 'Password123', 'candidate', 'premium'),
    ('Jack Turner', 'jack@example.com', 'Password123', 'candidate', 'free'),
    ('Zoe Bennett', 'zoe@example.com', 'Password123', 'candidate', 'premium'),
    ('Caleb Foster', 'caleb@example.com', 'Password123', 'candidate', 'free'),
    ('Nina Shah', 'nina@example.com', 'Password123', 'candidate', 'premium'),
    ('Victor Lane', 'victor@example.com', 'Password123', 'candidate', 'free'),
    ('Ruby Collins', 'ruby@example.com', 'Password123', 'candidate', 'premium'),
    ('Aiden Murphy', 'aiden@example.com', 'Password123', 'candidate', 'free'),
    ('Stella Park', 'stella@example.com', 'Password123', 'candidate', 'premium'),
    ('Julian Cross', 'julian@example.com', 'Password123', 'candidate', 'free'),
    ('Layla Ibrahim', 'layla@example.com', 'Password123', 'candidate', 'premium'),
    ('Theo Grant', 'theo@example.com', 'Password123', 'candidate', 'free'),
    ('Maya Rossi', 'maya@example.com', 'Password123', 'candidate', 'premium'),
    ('Connor Blake', 'connor@example.com', 'Password123', 'candidate', 'free'),
    ('SolarNest Energy Pty Ltd', 'solarnest@example.com', 'Password123', 'employer', 'premium'),
    ('PeakLine Logistics Pty Ltd', 'peakline@example.com', 'Password123', 'employer', 'free'),
    ('BluePeak Finance Pty Ltd', 'bluepeakfinance@example.com', 'Password123', 'employer', 'premium'),
    ('Orchard Learning Pty Ltd', 'orchardlearning@example.com', 'Password123', 'employer', 'free'),
    ('NeonForge Studios Pty Ltd', 'neonforge@example.com', 'Password123', 'employer', 'premium'),
    ('SilverOak Health Pty Ltd', 'silveroakhealth@example.com', 'Password123', 'employer', 'free'),
    ('MetroGrid Systems Pty Ltd', 'metrogrid@example.com', 'Password123', 'employer', 'premium'),
    ('FreshHarbor Retail Pty Ltd', 'freshharbor@example.com', 'Password123', 'employer', 'free'),
    ('CoreAxis Manufacturing Pty Ltd', 'coreaxis@example.com', 'Password123', 'employer', 'premium'),
    ('BrightWave Civic Pty Ltd', 'brightwavecivic@example.com', 'Password123', 'employer', 'free'),
    ('TrueNorth Travel Pty Ltd', 'truenorthtravel@example.com', 'Password123', 'employer', 'premium'),
    ('Lumina Biotech Pty Ltd', 'luminabiotech@example.com', 'Password123', 'employer', 'free'),
    ('RedStone Property Pty Ltd', 'redstoneproperty@example.com', 'Password123', 'employer', 'premium'),
    ('PulsePoint Fitness Pty Ltd', 'pulsepointfitness@example.com', 'Password123', 'employer', 'free')
